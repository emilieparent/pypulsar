...
def show_dictionary():
    raise NotImplementedError(
        "colours.show_dictionary needs to be implemented")
...
if __name__ == '__main__':
    ...
    parser.add_option('-s', '--set', dest='toset', type='string', action='callback', callback=parse_attributes,
                      help="Set text attributes. Possible attributes to set are: defaut, bold, dim, underline, blink, reverse and hidden.")
